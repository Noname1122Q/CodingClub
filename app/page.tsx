...
const LandingPage = () => {
  return (
    <div className=" text-gray-900 -mt-20">
      {/* Hero Section */}
      <section className="flex flex-col justify-center text-center items-center py-10 md:py-14 lg:py-18 px-0 md:px-4 bg-[url('https://images.shiksha.com/mediadata/images/1579757643phpEK1frD.jpeg')]  bg-no-repeat bg-cover h-screen">
        <h1 className=" text-lg sm:text-xl md:text-3xl lg:text-5xl font-bold text-[#CF2027]">
          Welcome to BITS Pilani Coding Club
        </h1>
        <p className=" text-sm md:text-lg lg:text-xl mt-4 text-black">
